...
public class DataHandler implements Parcelable{
	...
	public String getCupon_use2() {
		return cupon_use2;
	}
	public void setCupon_use2(String cupon_use2) {
		this.cupon_use2 = cupon_use2;
	}
	...
	public DataHandler (Parcel src){
		...
		this.cupon_use2 = src.readString();
	}
	...
	public void writeToParcel(Parcel dest, int flags) {
		...
		dest.writeString(this.cupon_use2);
	}
